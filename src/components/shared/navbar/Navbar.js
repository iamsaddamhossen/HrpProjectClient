        ...
        <div id="sidebar-menu" className="sidebar-menu">
          <ul>
            ...
            <li className="submenu">
              <a href="#!"><i className="la la-cog"></i> <span> Settings </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
                <li>
                  <a href="/DepartmentType">Department Type</a>
                  </li>

                  <li>
                  <a href="/WorkingHour">Working Hour</a>
                  </li>
              </ul>
            </li>
            ...
            {/* <li className="submenu">
              <a href="#"><i className="la la-dashboard"></i> <span> Dashboard</span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-cube"></i> <span> Apps</span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-rocket"></i> <span> Projects</span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-money"></i> <span> Payroll </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-pie-chart"></i> <span> Reports </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-graduation-cap"></i> <span> Performance </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-crosshairs"></i> <span> Goals </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-edit"></i> <span> Training </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-briefcase"></i> <span> Jobs </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-user"></i> <span> Profile </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-key"></i> <span> Authentication </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-exclamation-triangle"></i> <span> Error Pages </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-hand-o-up"></i> <span> Subscriptions </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-object-group"></i> <span> Forms </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li className="submenu">
              <a href="#"><i className="la la-table"></i> <span> Tables </span> <span className="menu-arrow"></span></a>
              <ul style={{ display: "none" }}>
            ...
            <li>
              <a href="javascript:void(0);"><i className="la la-info"></i> <span>Change Log</span> <span className="badge badge-primary ml-auto">v3.4</span></a>
            </li>
            <li className="submenu">
